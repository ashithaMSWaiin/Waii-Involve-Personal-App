...
let titleType = "";
if (process.argv[2] === "e") {
  appFolderPath = path.join(__dirname, "..", "involve-elements");
  ...
  appFolderPath = path.join(__dirname, "..", "involve-components");
  mainIndexFilePath = path.join(
    __dirname,
    "..",
    "involve-components",
...
.${name} {
  /* Add your styles here */
    ...
    // Append the export line to the main index.ts in involve-elements or involve-components
